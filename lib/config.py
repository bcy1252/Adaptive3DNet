...
# config of LI-Fusion
__C.AF_FUSION = edict()
__C.AF_FUSION.ENABLED = False
__C.AF_FUSION.IMG_FEATURES_CHANNEL = 128
__C.AF_FUSION.ADD_Image_Attention = False
__C.AF_FUSION.IMG_CHANNELS = [3, 64, 128, 256, 512]
__C.AF_FUSION.POINT_CHANNELS = [96, 256, 512, 1024]
__C.AF_FUSION.FUSION_CHANNELS = [160, 384, 768, 1536]

__C.AF_FUSION.DeConv_Reduce = [16, 16, 16, 16]
__C.AF_FUSION.DeConv_Kernels = [2, 4, 8, 16]
__C.AF_FUSION.DeConv_Strides = [2, 4, 8, 16]
