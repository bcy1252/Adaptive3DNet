    ...
    def train(self, start_it, start_epoch, n_epochs, train_loader, test_loader = None, ckpt_save_interval = 5,
        ...
        with tqdm.trange(start_epoch, n_epochs, desc = 'epochs') as tbar, \
            ...
            for epoch in tbar:
                ...
                if trained_epoch % ckpt_save_interval == 0 or trained_epoch > 40:
                ...
                torch.cuda.empty_cache()
                if trained_epoch == 1 or trained_epoch > 10:
                    if trained_epoch % 5 == 0 or trained_epoch == 1:
                        os.system("sh run_eval_model.sh {}".format(trained_epoch))
                # eval one epoch
